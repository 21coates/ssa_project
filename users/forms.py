...
class TopUpForm(forms.Form):
    amount = forms.DecimalField(min_value=0.01, decimal_places=2, max_digits=5, label="Amount to Top-Up", error_messages={'min_value': "Please enter an amount greater than $0.00.", 'invalid': "Enter a valid amount in dollars and cents.", 'max_digits': "Please enter a value that is 5 digits or less"})
